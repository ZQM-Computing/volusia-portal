...
MISSION_CATALOG = [
    ...
    # Tier 4.5 — Constituency Specialists
...
def contribute(req: ContributeRequest):
    ...
    for m in MISSION_CATALOG:
        ...
        # Constituency-specific missions (Pathways J-N)
