"""Add metadata footers to all 5 frontend pages."""
import os

base = '/c/Users/zqmco/Docker/volusia-portal'
footer_html = """
    {/* Metadata Footer */}
...
pages = {
    'src/pages/HomePage.tsx': ('      {/* Mission */}', footer_html + '\n      {/* Mission */}'),
    'src/pages/LeadersPage.tsx': ('      {/* Data Sources */}', footer_html + '\n      {/* Data Sources */}'),
    'src/pages/ResidentsPage.tsx': ('      {/* Data Sources */}', footer_html + '\n      {/* Data Sources */}'),
    'src/pages/TouristsPage.tsx': ('        </section>\n      )}', '        </section>\n      )}\n\n' + footer_html + '\n    </div>'),
    'src/pages/BusinessPage.tsx': ('      </div>\n    </div>\n  )\n}', footer_html + '\n      </div>\n    </div>\n  )\n}'),
}
